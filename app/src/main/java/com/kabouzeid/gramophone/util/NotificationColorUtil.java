...
public class NotificationColorUtil {
    ...
    //mine
    public static boolean isColorBackgroundLight(int backgroundColor) {
        return calculateLuminance(backgroundColor) > 0.2f;   //0.2f works good
    }
    ...
    private static class ColorUtilsFromCompat {
        ...
        static double calculateLuminance(@ColorInt int color) {
        ...
        private static float constrain(float amount, float high) {
            return amount < 0f ? 0f : (amount > high ? high : amount);
        }
